...
then
  ...
  #net_thread=hpguppi_meerkat_net_thread
  #net_thread=hpguppi_meerkat_pkt_thread
  net_thread="hpguppi_ibvpkt_thread -c 11 ata_volt_outer_thread"
  options="-o IBVPKTSZ=8,8192"
  bindport=4016
  instances[0]="${instances[0]/mnt/buf0}"
  # For initial testing...
  out_thread=null_output_thread
  #out_thread=ata_simple_output_thread
  shift
